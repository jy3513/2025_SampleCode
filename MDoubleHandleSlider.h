...
#include "MDoubleHandleSlider.generated.h"

/**
 *
 */

class SMDoubleHandleSlider;

UCLASS()
class UMDoubleHandleSlider : public USlider
{
	GENERATED_BODY()
...
protected:
	TSharedPtr<SMDoubleHandleSlider> MyDoubleHandleSlider;
