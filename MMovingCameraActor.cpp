...
void AMovingCameraActor::ChangeCamMode(APawn* InTargetNPCPawn, const bool bInReOpen)
{
	...
	//	change mode.
	const int CameraTypeIndex = GetCameraIndexFromMovingCamEnum(EMMovingCamMode::NpcTalk);
	LoadCameraMode(CameraTypeIndex, PlayerController->GetMoveCamSetting(EMMovingCamMode::NpcTalk));
