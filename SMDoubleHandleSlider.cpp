...
#include "UI/Common/SMDoubleHandleSlider.h"

SMDoubleHandleSlider::SMDoubleHandleSlider()
   : SecondValue(1.f)
   , FillImage(nullptr)
...
void SMDoubleHandleSlider::Construct(const FArguments& InArgs)
{
   Style = InArgs._Style;
...
int32 SMDoubleHandleSlider::OnPaint(const FPaintArgs& Args, const FGeometry& AllottedGeometry, const FSlateRect& MyCullingRect, FSlateWindowElementList& OutDrawElements, int32 LayerId, const FWidgetStyle& InWidgetStyle, bool bParentEnabled) const
{
...
FReply SMDoubleHandleSlider::OnMouseButtonDown(const FGeometry& MyGeometry, const FPointerEvent& MouseEvent)
{
...
FReply SMDoubleHandleSlider::OnMouseButtonUp(const FGeometry& MyGeometry, const FPointerEvent& MouseEvent)
{
   ResetHandle();
...
void SMDoubleHandleSlider::OnMouseCaptureLost(const FCaptureLostEvent& CaptureLostEvent)
{
   ResetHandle();
...
FReply SMDoubleHandleSlider::OnMouseMove(const FGeometry& MyGeometry, const FPointerEvent& MouseEvent)
{
...
FReply SMDoubleHandleSlider::OnTouchMoved(const FGeometry& MyGeometry, const FPointerEvent& InTouchEvent)
{
...
FReply SMDoubleHandleSlider::OnTouchEnded(const FGeometry& MyGeometry, const FPointerEvent& InTouchEvent)
{
   ResetHandle();
...
void SMDoubleHandleSlider::OnFocusLost(const FFocusEvent& InFocusEvent)
{
   ResetHandle();
...
FNavigationReply SMDoubleHandleSlider::OnNavigation(const FGeometry& MyGeometry, const FNavigationEvent& InNavigationEvent)
{
   return FNavigationReply::Escape();
}

float SMDoubleHandleSlider::GetFirstValue() const
{
   return GetValue();
}

float SMDoubleHandleSlider::GetSecondValue() const
{
   return SecondValue;
}

float SMDoubleHandleSlider::GetNormalizedFirstValue() const
{
   return GetNormalizedValue();
}

float SMDoubleHandleSlider::GetNormalizedSecondValue() const
{
...
void SMDoubleHandleSlider::SetFirstValue(TAttribute<float> InValueAttribute)
{
   SetValue(InValueAttribute);
}

void SMDoubleHandleSlider::SetSecondValue(TAttribute<float> InValueAttribute)
{
   SecondValue = InValueAttribute.Get();
}

void SMDoubleHandleSlider::CommitValue(float InNewValue)
{
...
const FSlateBrush* SMDoubleHandleSlider::GetFillImage() const
{
   return FillImage ? FillImage : &Style->NormalBarImage;
}

void SMDoubleHandleSlider::ResetHandle()
{
   IsFirstHandle = false;
   IsSecondHandle = false;
}

void SMDoubleHandleSlider::CheckHandle(const FGeometry& MyGeometry, const UE::Slate::FDeprecateVector2DParameter& AbsolutePosition)
{
